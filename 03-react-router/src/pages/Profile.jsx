            ...
            <div className={styles.container}>
                ...
                <div className={styles.section}>
                    ...
                    <div className={styles.experienceItem}>
                        ...
                        <p className={styles.experienceDescription}>Desarrollo de aplicaciones web con React, TypeScript y Next.js</p>
                    </div>
                    <div className={styles.experienceItem}>
                        <h3 className={styles.experienceTitle}>Desarrollador Junior</h3>
                        <p className={styles.experienceCompany}>Startup ABC • 2019 - 2021</p>
                        <p className={styles.experienceDescription}>Mantenimiento y desarrollo de features en aplicaciones legacy</p>
                    </div>
                </div>
